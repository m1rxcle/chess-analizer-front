	...
	return (
		...
		>
			<div className="hidden lg:block absolute -top-34 left-1/2 rotate-.5 select-none pointer-events-none  z-10">
				<Image loading="lazy" src="/footer-pic1.png" alt="footer-pic" width={500} height={500} />
			</div>

			<div className="space-y-4 relative z-20  text-center md:text-left lg:mr-auto max-w-2xl">
				<h1 className="text-3xl md:text-4xl font-bold ">Готовы улучшить свою игру?</h1>
				<p className="text-xl font-semibold text-secondary ">Присоединяйтесь к тысячам шахматистов, которые уже анализируют свои партии</p>
			</div>
			<FindPlayerButton />
			<div className="lg:hidden absolute bottom-0 -left-5 rotate-0 select-none pointer-events-none -z-10 opacity-70">
				<Image loading="lazy" sizes="(max-width: 768px) 100vw, 50vw" src="/footer-pic1.png" alt="footer-pic" width={200} height={200} />
			</div>
		</footer>
	)
}
